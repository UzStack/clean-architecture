...
1. **[Clean Architecture](./01-clean-architecture.md)** - 860+ qator
    - Qatlamlar va Dependency Rule
    - Use Cases va Entities
    - Amaliy e-commerce misoli
    - Folder structure

2. **[SOLID Prinsiplari](./02-solid-principles.md)** - 1385+ qator
...
3. **[Design Patterns](./03-design-patterns.md)** - 1230+ qator
    - Creational Patterns (Singleton, Factory, Builder)
    - Structural Patterns (Adapter, Decorator, Facade)
    - Behavioral Patterns (Strategy, Observer, Command)
    - Anti-patterns va qilmaslik kerak bo'lgan narsalar

4. **[Domain-Driven Design](./04-domain-driven-design.md)** - 850+ qator
...
5. **[Testing Strategiyalari](./05-testing-strategies.md)** - 800+ qator
    - Unit Testing
    - Integration Testing
...
✅ Clean Architecture'ni to'liq tushunsiz va qo'llaysiz
✅ SOLID prinsiplarini real loyihalarda ishlatasiz
✅ 20+ Design Pattern'ni bilasiz va qachon ishlatishni tushunasiz
✅ Domain-Driven Design bilan murakkab tizimlar yasaysiz
✅ Professional darajada test yozasiz (Unit, Integration, E2E)
✅ Arxitektura qarorlarini to'g'ri qabul qilasiz
✅ Team'ga texnik yo'l-yo'riq berasiz
✅ **Senior Developer sifatida ishlashga tayyor bo'lasiz!**
...
👉 **[01 - Clean Architecture](./01-clean-architecture.md)**
